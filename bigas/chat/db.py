...
DEFAULT_AGENTS = [
    ...
    },
    {
        ...
        "system_prompt_goals": (
            ...
            "If a workflow fails, fetch the failed logs, post a diagnosis, and launch a CTO "
            "Cursor agent (fix_failed_deployment) to open a fix PR — do not stop at the red X. "
