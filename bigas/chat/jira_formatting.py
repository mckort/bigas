...
- Omit parent_epic_key unless the user named a known Epic key. Creating a Task/Bug without a parent is the default. Never invent a parent, and never use a Task or Bug as parent.
