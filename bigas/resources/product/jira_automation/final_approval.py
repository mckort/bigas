...
def _align_pr_base_to_board_release(
    *,
    ...
    from bigas.tickets.releases import default_fix_version, is_board_version_pr_forbidden
    ...
    if fix_version and is_board_version_pr_forbidden(project_key, fix_version):
