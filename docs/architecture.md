...
- **Scheduling**: `POST /tasks/eval/vfa-living-analysis` (Cloud Scheduler 1st of each month, 16:00 Europe/Stockholm) or `python scripts/run_eval.py --pack vfa-living-analysis`.
