...
To add another product board (for example **FRI Board** / project `FRI`), extend `JIRA_PROJECT_KEY` and follow [friman-investments-board.md](friman-investments-board.md).
