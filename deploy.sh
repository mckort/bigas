...
# YAML format: KEY: "value"
{
  ...
  [ -n "$BIGAS_OKR_RESEARCH_MODEL" ] && echo "BIGAS_OKR_RESEARCH_MODEL: \"$BIGAS_OKR_RESEARCH_MODEL\""
  [ -n "$BIGAS_OKR_PLAN_MODEL" ] && echo "BIGAS_OKR_PLAN_MODEL: \"$BIGAS_OKR_PLAN_MODEL\""
  [ -n "$BIGAS_PROACTIVE_GOALS_MODEL" ] && echo "BIGAS_PROACTIVE_GOALS_MODEL: \"$BIGAS_PROACTIVE_GOALS_MODEL\""
  [ -n "$BIGAS_USAGE_PROVIDERS" ] && echo "BIGAS_USAGE_PROVIDERS: \"$BIGAS_USAGE_PROVIDERS\""
  [ -n "$BIGAS_LLM_USAGE_PROJECTS" ] && echo "BIGAS_LLM_USAGE_PROJECTS: \"$BIGAS_LLM_USAGE_PROJECTS\""
  [ -n "$BIGAS_GCP_BILLING_DATASET" ] && echo "BIGAS_GCP_BILLING_DATASET: \"$BIGAS_GCP_BILLING_DATASET\""
  [ -n "$BIGAS_GCP_BILLING_TABLE" ] && echo "BIGAS_GCP_BILLING_TABLE: \"$BIGAS_GCP_BILLING_TABLE\""
  [ -n "$BIGAS_BILLING_ACCOUNT" ] && echo "BIGAS_BILLING_ACCOUNT: \"$BIGAS_BILLING_ACCOUNT\""
  [ -n "$BIGAS_TAVILY_USAGE_PROJECT" ] && echo "BIGAS_TAVILY_USAGE_PROJECT: \"$BIGAS_TAVILY_USAGE_PROJECT\""
  [ -n "$BIGAS_CTO_PR_REVIEW_MODEL" ] && echo "BIGAS_CTO_PR_REVIEW_MODEL: \"$BIGAS_CTO_PR_REVIEW_MODEL\""
  [ -n "$BIGAS_CTO_PR_REVIEW_MAX_TOKENS" ] && echo "BIGAS_CTO_PR_REVIEW_MAX_TOKENS: \"$BIGAS_CTO_PR_REVIEW_MAX_TOKENS\""
  [ -n "$BIGAS_CTO_PR_REVIEW_THINKING_BUDGET" ] && echo "BIGAS_CTO_PR_REVIEW_THINKING_BUDGET: \"$BIGAS_CTO_PR_REVIEW_THINKING_BUDGET\""
  [ -n "$BIGAS_CTO_PR_REVIEW_MAX_CONTINUATIONS" ] && echo "BIGAS_CTO_PR_REVIEW_MAX_CONTINUATIONS: \"$BIGAS_CTO_PR_REVIEW_MAX_CONTINUATIONS\""
  [ -n "$BIGAS_CTO_AUTOFIX_MODEL" ] && echo "BIGAS_CTO_AUTOFIX_MODEL: \"$BIGAS_CTO_AUTOFIX_MODEL\""
  [ -n "$BIGAS_CTO_AUTO_MERGE" ] && echo "BIGAS_CTO_AUTO_MERGE: \"$BIGAS_CTO_AUTO_MERGE\""
  ...
  [ -n "$BIGAS_JIRA_AUTOMATION_ALLOWED_PROJECTS" ] && echo "BIGAS_JIRA_AUTOMATION_ALLOWED_PROJECTS: \"$BIGAS_JIRA_AUTOMATION_ALLOWED_PROJECTS\""
  [ -n "$BIGAS_JIRA_PROJECT_REPO_MAP" ] && echo "BIGAS_JIRA_PROJECT_REPO_MAP: \"$BIGAS_JIRA_PROJECT_REPO_MAP\""
  [ -n "$BIGAS_JIRA_REPO_BASE_BRANCH_MAP" ] && echo "BIGAS_JIRA_REPO_BASE_BRANCH_MAP: \"$BIGAS_JIRA_REPO_BASE_BRANCH_MAP\""
  [ -n "$BIGAS_JIRA_DEFAULT_BASE_BRANCH" ] && echo "BIGAS_JIRA_DEFAULT_BASE_BRANCH: \"$BIGAS_JIRA_DEFAULT_BASE_BRANCH\""
  [ -n "$PROJECT_BRANCH_MAPPING" ] && echo "PROJECT_BRANCH_MAPPING: \"$PROJECT_BRANCH_MAPPING\""
  [ -n "$BIGAS_GA4_PROPERTY_MAP" ] && echo "BIGAS_GA4_PROPERTY_MAP: \"$BIGAS_GA4_PROPERTY_MAP\""
  [ -n "$BIGAS_DEPLOY_WORKFLOW_MAP" ] && echo "BIGAS_DEPLOY_WORKFLOW_MAP: \"$BIGAS_DEPLOY_WORKFLOW_MAP\""
  [ -n "$BIGAS_DEPLOY_REPO_MAP" ] && echo "BIGAS_DEPLOY_REPO_MAP: \"$BIGAS_DEPLOY_REPO_MAP\""
  [ -n "$USE_INTERNAL_BOARD" ] && echo "USE_INTERNAL_BOARD: \"$USE_INTERNAL_BOARD\""
  ...
  [ -n "$ENABLE_OUTBOUND_EMAIL" ] && echo "ENABLE_OUTBOUND_EMAIL: \"$ENABLE_OUTBOUND_EMAIL\""
  ...
  [ -n "$CHAT_ADMIN_EMAILS" ] && echo "CHAT_ADMIN_EMAILS: \"$CHAT_ADMIN_EMAILS\""
  [ -n "$CHAT_ALLOWED_EMAILS" ] && echo "CHAT_ALLOWED_EMAILS: \"$CHAT_ALLOWED_EMAILS\""
