...
# Optional Google Ads (Paid Ads reporting)
GOOGLE_ADS_ENV_VAR=""
...
gcloud run deploy mcp-marketing \
    ...
    --set-env-vars DEPLOYMENT_MODE=$DEPLOYMENT_MODE,GA4_PROPERTY_ID=$GA4_PROPERTY_ID,OPENAI_API_KEY=$OPENAI_API_KEY$DISCORD_ENV_VAR$JIRA_ENV_VAR$STORAGE_ENV_VAR$KEYWORDS_ENV_VAR$GOOGLE_ADS_ENV_VAR$LINKEDIN_ENV_VAR
