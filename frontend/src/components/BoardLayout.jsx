  ...
  return (
    <div className="h-screen-safe flex flex-col lg:flex-row overflow-hidden bg-bg mobile-nav-offset">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="header-bar px-3 sm:px-4 py-3 flex items-center gap-2">
          ...
          {showEpicFilter && (
            <select
              ...
              className="text-sm px-2 py-2 rounded-lg border border-border min-h-[44px] max-w-[160px] sm:max-w-[220px] bg-elevated input-field py-2"
          ...
          <button
            ...
            className="btn-accent font-medium px-3 py-2 rounded-lg min-h-[44px] text-sm"
          >
            + Ticket
          </button>
