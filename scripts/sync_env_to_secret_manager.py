...
SECRET_NAMES = [
    ...
    "X_ACCESS_TOKEN_BIGASMYAITEAM",
    "X_ACCESS_SECRET_BIGASMYAITEAM",
    "X_API_KEY_VCFIELDASSISAN",
    "X_API_SECRET_VCFIELDASSISAN",
    "X_ACCESS_TOKEN_VCFIELDASSISAN",
    "X_ACCESS_SECRET_VCFIELDASSISAN",
    "BIGAS_EMAIL_IMAP_SERVER",
    "BIGAS_EMAIL_USERNAME",
    "BIGAS_EMAIL_PASSWORD",
    "BIGAS_DEPLOY_WORKFLOW_MAP",
    "BIGAS_DEPLOY_REPO_MAP",
]
